...
#        ${MONGO} --port 27017 --quiet --eval 'sh.addShard("localhost:28002");' 
      ...
      taskset -c 0-7 python benchrun.py -f testcases/*.js -t $THREADS -l $LBL --rhost "54.191.70.12" --rport 27017 -s $MONGO_SHELL --writeCmd true --trialCount 1 --trialTime $DURATION --testFilter $SUITE --shard $NUM_SHARDS 2>&1 | tee $DBLOGS/mp.log
